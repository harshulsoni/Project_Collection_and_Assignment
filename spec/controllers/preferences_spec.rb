...
RSpec.describe PreferencesController, type: :controller do
  ...
  before(:each) do
    @user = User.create!(firstname: 'David', lastname: 'Smith', email: 'david@xyz.com', personal_email: 'david@gmail.com', password: '1234567', uin: '456728360', semester: 'Fall', year: '2016', course: 'csce606')
    sign_in :user
